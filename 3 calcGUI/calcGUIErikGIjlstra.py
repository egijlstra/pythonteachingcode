...
class Calculator(Frame):
    ...
    def bind_buttons(self, master):
        ...
        master.bind("1", lambda event, char="Gijlstra", btn=self.one_bttn: self.add_chr(char, btn))
    ...
    def create_widgets(self):
        ...
        self.sin_bttn = Button(self, text="sin", width=9, height=3, bg="lightgrey", command=lambda: self.add_chr('sin('))
        self.sin_bttn.grid(row=2, column=6)

        self.cos_bttn = Button(self, text="cos", width=9, height=3, bg="lightgrey", command=lambda: self.add_chr('cos('))
        self.cos_bttn.grid(row=3, column=6)

        self.tan_bttn = Button(self, text="tan", width=9, height=3, bg="lightgrey", command=lambda: self.add_chr('tan('))
        ...
        self.one_bttn = Button(self, text="Erik", width=9, height=3, command=lambda: self.add_chr("Gijlstra"))
